    ...
    <div class="page-ttl">
        <div class="layer-stretch">
            <div class="page-ttl-container">
                ...
                <p><a href="<%=request.getContextPath()%>/">Trang chủ</a> &#8594; <span>Tra cứu thông tin lịch hẹn</span></p>
            </div>
        </div>
        ...
        <div class="layer-wrapper text-center">
            <div class="row">
                <div class="col-lg-8">
					...
					<form action = "<%=request.getContextPath()%>/searchAppointment">
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input-icon">
				               <i class="fa fa-arrow-right"></i>
				               <input style = "padding-left: 10px;" class="mdl-textfield__input" type="text" pattern="^[a-zA-Z0-9]{10}$" id="token" name = "token">
				               <label class="mdl-textfield__label" for="sample-text-1">Nhập mã ở đây</label>
				               <span class="mdl-textfield__error">Làm ơn nhập đủ 10 kí tự!</span>
				        </div>
				           <button class="mdl-button mdl-js-button mdl-button--colored mdl-js-ripple-effect button button-primary button-sm m-1">Tra cứu</button>  
				           </form>          
                </div>
                <div class="col-lg-4">
