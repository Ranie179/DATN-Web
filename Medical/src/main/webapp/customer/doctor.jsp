    ...
    <div class="page-ttl">
        <div class="layer-stretch">
            <div class="page-ttl-container">
                ...
                <p><a href="<%=request.getContextPath()%>/">Trang chủ</a> &#8594; <a href="<%=request.getContextPath()%>/showAllDoctor">Danh sách bác sĩ</a> &#8594; <span><c:out value="${doctorInfo.doctorName}" /></span></p>
            </div>
        </div>
