    ...
    <div class="page-ttl">
        <div class="layer-stretch">
            <div class="page-ttl-container">
                ...
                <p><a href="<%=request.getContextPath()%>/">Trang chủ</a> &#8594; <a href="<%=request.getContextPath()%>/showAllDepartment">Khoa</a> &#8594; <span><c:out value="${departmentInfo.departmentName}" /></span></p>
            </div>
        </div>
            ...
            <div class="row layer-wrapper">
                ...
                <div class="col-lg-4">
                   <div class="theme-material-card">
                        ...
                        <div class="flexslider theme-flexslider text-center">
                            <ul class="slides">
