    ...
    <div class="page-ttl">
        <div class="layer-stretch">
            <div class="page-ttl-container">
                ...
                <p><a href="<%=request.getContextPath()%>/">Trang chủ</a> &#8594; <a href="<%=request.getContextPath()%>/showAllService">Dịch vụ</a> &#8594; <span><c:out value="${serviceInfo.name}" /></span></p>
            </div>
        </div>
                    ...
                    <div class="theme-material-card">
                        ...
                        <c:if test="${not empty failed}">
						    <div style = "width:100%; color: #d30b0b;" class="alert alert-danger" role="alert">
                                <strong>Xin lỗi!</strong> Bạn cần đăng nhập trước khi bình luận
                        ...
                        <div class="row comment-form">
                            <div class="col-sm-6">
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input">
                                    <input class="mdl-textfield__input" type="text" id="email" name = "email" readonly value = "${email }">
                            ...
                            <div class="col-sm-12">
                                <div class="mdl-textfield mdl-js-textfield form-input">
                                    ...
                                    <span id="comment-invalid" style="color: #eb1c26; margin-top: 10px; display:none">Vui lòng nhập bình luận</span>
                                </div>
                            </div>
                            <div class="col-sm-12">
