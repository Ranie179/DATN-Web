        ...
        <div class="layer-wrapper">
            ...
            <p style = "text-align: center;"class="font-16">Thêm khoa mới</p>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="theme-img theme-img-scalerotate">
                        	<img class="" src="/Medical/resources/images/585x390.jpg" alt="">
                            <p style = "text-align: center;"class="font-16">Thêm ảnh tại đây</p>
                        </div>
						<input type="file" name="file" />
                   	</div>
                   	<div class="col-md-8">
                   		<input style = "display: none;" class="mdl-textfield__input" type="text" id="id" name = "id">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input-icon">
                            ...
                            <textarea class="mdl-textfield__input" rows="5" id="intro"name = "intro"  maxLength = "100"></textarea>
                    ...
                    <div class="col-md-12">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input-icon">
                            ...
                            <textarea class="mdl-textfield__input" rows="8" id="information" name = "information"></textarea>
                ...
                <div class="form-submit">
                    <button type = "submit" class="mdl-button mdl-js-button mdl-js-ripple-effect button button-primary">Thêm</button>
                </div>
            </div>  
        </div>
    </div>
