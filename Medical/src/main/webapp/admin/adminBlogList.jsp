        ...
        <div class="layer-wrapper">
            <div class="row">
        		...
        		<div style = "margin: 0 0 0 0;" class="theme-material-card">
                            <p class="font-16 text-center">Danh sách bài viết hiện có</p>
				 ...
				 <ul class="theme-pagination text-center">
				        <c:choose>
				            <c:when test="${currentPage > 1}">
				                <li><a href="<%=request.getContextPath()%>/adminShowBlog?page=${currentPage - 1}">&laquo; Previous</a></li>
				            </c:when>
				            <c:otherwise>
				        ...
				        <c:forEach begin="1" end="${totalPages}" varStatus="loop">
				            <c:choose>
				                ...
				                <c:otherwise>
				                    <li><a href="<%=request.getContextPath()%>/adminShowBlog?page=${loop.index}">${loop.index}</a></li>
				                </c:otherwise>
				            </c:choose>
				        </c:forEach>
				        ...
				        <c:choose>
				            <c:when test="${currentPage < totalPages}">
				                <li><a href="<%=request.getContextPath()%>/adminShowBlog?page=${currentPage + 1}">Next &raquo;</a></li>
				            </c:when>
				            <c:otherwise>
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input">
                         <form class="searchform" action="<%=request.getContextPath()%>/adminShowService" method="GET">
						    ...
						    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label form-input">
						        ...
						        <label class="mdl-textfield__label" for="sidebar-search">Tìm theo tên bài viết</label>
    ...
    <script>
		function confirmDeleteBlog(id) {
			  if (confirm("Bạn có chắc muốn xóa tin này không?")) {
				  console.log("adminDeleteBlog?id=" + id)
