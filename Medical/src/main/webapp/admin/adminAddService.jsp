    ...
    <div id="profile-page" class="layer-stretch">
        <div class="layer-wrapper">
        	...
        	<div class="layer-wrapper layer-bottom-5">
                        <div class="theme-img theme-img-scalerotate"><img src="/Medical/resources/images/1920x800-slider.jpg" alt=""></div>
                            ...
                            <div class="row">
                                ...
                                <div style = "margin-left: 70px;" class="col-md-5">
                                    <div class="theme-img theme-img-scalerotate">
                                        <img src="/Medical/resources/images/530x470-theme-block.jpg" alt="">
                                    </div>
